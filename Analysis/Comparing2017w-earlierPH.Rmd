...
final <- subset(final, From_15 == "ph2016" | From_14 == "all2014.RData" | From_17 == "ph2017")
...
length(final$TCode[(final$PH_or_S8 == "PH" | final$PH_or_S8 == "PH_or_S8.x" | final$PH_or_S8 == "PH_or_S8.1") & !is.na(final$total.answered_14) & final$total.answered_14 > 0])
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  theme(
  ...
  xlab("") +
  ggtitle("Housing\n") +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.7), hjust=1, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue", "navyblue"), name="")
```
...
percentYes <- function(qn, i) {
  ...
  a16 <-eval(parse(text = paste0("final$Q", as.character(qn), "_", as.character(i), "_16")))
  
  yes_16 <- as.integer(summary(as.factor(a16))["Yes"])
  no_16 <- as.integer(summary(as.factor(a16))["No"])
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
  
  yes_14 <- as.integer(summary(as.factor(a14))["Yes"])
  no_14 <- as.integer(summary(as.factor(a14))["No"])
  percent_y_14 <- (yes_14)* 100 / (yes_14 + no_14)
  
  return(c(percent_y_14, percent_y_16))
}
...
pct_Yes_2014 <- pct_Yes_2016 <- c()
for(i in 1:9) {
  pct_Yes_2014[i] <- percentYes(3, i)[1]
  pct_Yes_2016[i] <- percentYes(3, i)[2]
}
...
for(i in 1:length(x)) {
  N_2014[i] <- eval(parse(text = paste0("length(final$", strsplit(x[i], ":", fixed = FALSE)[[1]][1], "_14[!is.na(final$", strsplit(x[i], ":", fixed = FALSE)[[1]][1], "_14)])", sep = "")))
  N_2016[i] <- eval(parse(text = paste0("length(final$", strsplit(x[i], ":", fixed = FALSE)[[1]][1], "_16[!is.na(final$", strsplit(x[i], ":", fixed = FALSE)[[1]][1], "_16)])", sep = "")))
} 
d <- data.frame(Question = x, pct_Yes_2014, pct_Yes_2016)
d <- melt(d, id.vars = "Question", variable.name="Year", value.name="Percent_Yes")
d$N <- c(N_2014, N_2016)
d$Percent_Yes_text <- paste0(as.character(round(d$Percent_Yes, 0)), "% (N=", as.character(d$N), ")", sep="")
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered Yes ") +
  xlab("") +
  ggtitle("Is this a barrier to SS in Housing?\n") +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.7), hjust=1, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
Q5Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q5_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("d. Unemployed, and seeking work", "e. Unemployed and not seeking work")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[levels(final$Q5_14)[1:3]]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
Q6Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q6_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("a. Definitely yes", "b. Probably yes")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("c. Not sure", "d. Probably not", "e. Definitely not")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
Q7Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q7_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("4 My skills somehow qualify me for a better paying job.", "5 My skills definitely qualify me for a better paying job.")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("1 My skills do not qualify me for a better paying job at all.", "2 My skills somehow does not qualify me for a better paying job.", "3 Neutral.")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
pct_Yes_2016[1] <- Q5Yes()[2]
pct_Yes_2014[2] <- Q6Yes()[1]
pct_Yes_2016[2] <- Q6Yes()[2]
pct_Yes_2014[3] <- Q7Yes()[1]
pct_Yes_2016[3] <- Q7Yes()[2]
...
final$Q8_1_14 <- NA
final$Q8_1_16 <- NA
#summary(final$Q8_1_14)
#summary(final$Q8_1_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_1_16[i]) & !is.na(final$Q8_2_1_16[i])){
  if(final$Q8_1_1_16[i] == "No" | final$Q8_2_1_16[i] == "No") final$Q8_1_16[i] <- "No"
  if(final$Q8_1_1_16[i] == "Yes" | final$Q8_2_1_16[i] == "Yes") final$Q8_1_16[i] <- "Yes"
}
final$Q8_1_14 <- as.factor(final$Q8_1_14)
final$Q8_1_16 <- as.factor(final$Q8_1_16)
...
final$Q8_2_14 <- NA
final$Q8_2_16 <- NA
#summary(final$Q8_2_14)
#summary(final$Q8_2_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_2_16[i]) & !is.na(final$Q8_2_2_16[i])) {
  if(final$Q8_1_2_16[i] == "No" | final$Q8_2_2_16[i] == "No") final$Q8_2_16[i] <- "No"
  if(final$Q8_1_2_16[i] == "Yes" | final$Q8_2_2_16[i] == "Yes") final$Q8_2_16[i] <- "Yes"
}
final$Q8_2_14 <- as.factor(final$Q8_2_14)
final$Q8_2_16 <- as.factor(final$Q8_2_16)


final$Q8_3_14 <- NA
final$Q8_3_16 <- NA
#summary(final$Q8_3_14)
#summary(final$Q8_3_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_3_16[i]) & !is.na(final$Q8_2_3_16[i])) {
  if(final$Q8_1_3_16[i] == "No" | final$Q8_2_3_16[i] == "No") final$Q8_3_16[i] <- "No"
  if(final$Q8_1_3_16[i] == "Yes" | final$Q8_2_3_16[i] == "Yes") final$Q8_3_16[i] <- "Yes"
}
final$Q8_3_14 <- as.factor(final$Q8_3_14)
final$Q8_3_16 <- as.factor(final$Q8_3_16)

final$Q8_4_14 <- NA
final$Q8_4_16 <- NA
#summary(final$Q8_4_14)
#summary(final$Q8_4_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_4_16[i]) & !is.na(final$Q8_2_4_16[i])) {
  if(final$Q8_1_4_16[i] == "No" | final$Q8_2_4_16[i] == "No") final$Q8_4_16[i] <- "No"
  if(final$Q8_1_4_16[i] == "Yes" | final$Q8_2_4_16[i] == "Yes") final$Q8_4_16[i] <- "Yes"
}
final$Q8_4_14 <- as.factor(final$Q8_4_14)
final$Q8_4_16 <- as.factor(final$Q8_4_16)


final$Q8_5_14 <- NA
final$Q8_5_16 <- NA
#summary(final$Q8_5_14)
#summary(final$Q8_5_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_5_16[i]) & !is.na(final$Q8_2_5_16[i])) {
  if(final$Q8_1_5_16[i] == "No" | final$Q8_2_5_16[i] == "No") final$Q8_5_16[i] <- "No"
  if(final$Q8_1_5_16[i] == "Yes" | final$Q8_2_5_16[i] == "Yes") final$Q8_5_16[i] <- "Yes"
}
final$Q8_5_14 <- as.factor(final$Q8_5_14)
final$Q8_5_16 <- as.factor(final$Q8_5_16)


final$Q8_6_14 <- NA
final$Q8_6_16 <- NA
#summary(final$Q8_6_14)
#summary(final$Q8_6_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_6_16[i]) & !is.na(final$Q8_2_6_16[i])) {
  if(final$Q8_1_6_16[i] == "No" | final$Q8_2_6_16[i] == "No") final$Q8_6_16[i] <- "No"
  if(final$Q8_1_6_16[i] == "Yes" | final$Q8_2_6_16[i] == "Yes") final$Q8_6_16[i] <- "Yes"
}
final$Q8_6_14 <- as.factor(final$Q8_6_14)
final$Q8_6_16 <- as.factor(final$Q8_6_16)


final$Q8_7_14 <- NA
final$Q8_7_16 <- NA
#summary(final$Q8_7_14)
#summary(final$Q8_7_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_7_16[i]) & !is.na(final$Q8_2_7_16[i])) {
  if(final$Q8_1_7_16[i] == "No" | final$Q8_2_7_16[i] == "No") final$Q8_7_16[i] <- "No"
  if(final$Q8_1_7_16[i] == "Yes" | final$Q8_2_7_16[i] == "Yes") final$Q8_7_16[i] <- "Yes"
}
final$Q8_7_14 <- as.factor(final$Q8_7_14)
final$Q8_7_16 <- as.factor(final$Q8_7_16)

final$Q8_8_14 <- NA
final$Q8_8_16 <- NA
#summary(final$Q8_8_14)
#summary(final$Q8_8_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_8_16[i]) & !is.na(final$Q8_2_8_16[i])) {
  if(final$Q8_1_8_16[i] == "No" | final$Q8_2_8_16[i] == "No") final$Q8_8_16[i] <- "No"
  if(final$Q8_1_8_16[i] == "Yes" | final$Q8_2_8_16[i] == "Yes") final$Q8_8_16[i] <- "Yes"
}
final$Q8_8_14 <- as.factor(final$Q8_8_14)
final$Q8_8_16 <- as.factor(final$Q8_8_16)


final$Q8_9_14 <- NA
final$Q8_9_16 <- NA
#summary(final$Q8_9_14)
#summary(final$Q8_9_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_9_16[i]) & !is.na(final$Q8_2_9_16[i])) {
  if(final$Q8_1_9_16[i] == "No" | final$Q8_2_9_16[i] == "No") final$Q8_9_16[i] <- "No"
  if(final$Q8_1_9_16[i] == "Yes" | final$Q8_2_9_16[i] == "Yes") final$Q8_9_16[i] <- "Yes"
}
final$Q8_9_14 <- as.factor(final$Q8_9_14)
final$Q8_9_16 <- as.factor(final$Q8_9_16)


final$Q8_10_14 <- NA
final$Q8_10_16 <- NA
#summary(final$Q8_10_14)
#summary(final$Q8_10_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_10_16[i]) & !is.na(final$Q8_2_10_16[i])) {
  if(final$Q8_1_10_16[i] == "No" | final$Q8_2_10_16[i] == "No") final$Q8_10_16[i] <- "No"
  if(final$Q8_1_10_16[i] == "Yes" | final$Q8_2_10_16[i] == "Yes") final$Q8_10_16[i] <- "Yes"
}
final$Q8_10_14 <- as.factor(final$Q8_10_14)
final$Q8_10_16 <- as.factor(final$Q8_10_16)


final$Q8_11_14 <- NA
final$Q8_11_16 <- NA
#summary(final$Q8_11_14)
#summary(final$Q8_11_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_11_16[i]) & !is.na(final$Q8_2_11_16[i])) {
  if(final$Q8_1_11_16[i] == "No" | final$Q8_2_11_16[i] == "No") final$Q8_11_16[i] <- "No"
  if(final$Q8_1_11_16[i] == "Yes" | final$Q8_2_11_16[i] == "Yes") final$Q8_11_16[i] <- "Yes"
}
final$Q8_11_14 <- as.factor(final$Q8_11_14)
final$Q8_11_16 <- as.factor(final$Q8_11_16)


final$Q8_12_14 <- NA
final$Q8_12_16 <- NA
#summary(final$Q8_12_14)
#summary(final$Q8_12_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_12_16[i]) & !is.na(final$Q8_2_12_16[i])) {
  if(final$Q8_1_12_16[i] == "No" | final$Q8_2_12_16[i] == "No") final$Q8_12_16[i] <- "No"
  if(final$Q8_1_12_16[i] == "Yes" | final$Q8_2_12_16[i] == "Yes") final$Q8_12_16[i] <- "Yes"
}
final$Q8_12_14 <- as.factor(final$Q8_12_14)
final$Q8_12_16 <- as.factor(final$Q8_12_16)


final$Q8_13_14 <- NA
final$Q8_13_16 <- NA
#summary(final$Q8_13_14)
#summary(final$Q8_13_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_13_16[i]) & !is.na(final$Q8_2_13_16[i])) {
  if(final$Q8_1_13_16[i] == "No" | final$Q8_2_13_16[i] == "No") final$Q8_13_16[i] <- "No"
  if(final$Q8_1_13_16[i] == "Yes" | final$Q8_2_13_16[i] == "Yes") final$Q8_13_16[i] <- "Yes"
}
final$Q8_13_14 <- as.factor(final$Q8_13_14)
final$Q8_13_16 <- as.factor(final$Q8_13_16)



final$Q8_14_14 <- NA
final$Q8_14_16 <- NA
#summary(final$Q8_14_14)
#summary(final$Q8_14_16)
...
for(i in 1:length(final$TCode)) if(!is.na(final$Q8_1_14_16[i]) & !is.na(final$Q8_2_14_16[i])) {
  if(final$Q8_1_14_16[i] == "No" | final$Q8_2_14_16[i] == "No") final$Q8_14_16[i] <- "No"
  if(final$Q8_1_14_16[i] == "Yes" | final$Q8_2_14_16[i] == "Yes") final$Q8_14_16[i] <- "Yes"
}
final$Q8_14_14 <- as.factor(final$Q8_14_14)
final$Q8_14_16 <- as.factor(final$Q8_14_16)
...
```{r, message = FALSE, echo=FALSE, fig.height=9, fig.width=11, warning=FALSE}
...
percentYes <- function(qn, i) {
  ...
  y_16 <- as.integer(summary(as.factor(a16))["Yes"])
  n_16 <- as.integer(summary(as.factor(a16))["No"])
  percent_y_16 <- y_16 * 100 / (y_16 + n_16)
...
for(i in 1:14) {
  ...
  pct_Yes_2016[i] <- percentYes(8, i)[2]
}
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered Yes") + 
  xlab(" ") + 
  ggtitle("Is this a barrier to employment?\n") +
  #scale_fill_discrete(name = "", labels = c("Y in '14, N in '16", "No change", "N in '14, Y in '16")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = .93), vjust=0.25, hjust=1, size=3, alpha=0.7) +
...
```{r, message = FALSE, echo=FALSE, fig.height=1.5, fig.width=9}
...
Q9Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q9_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("b. Yes, 1 time", "c. Yes, 2 times", "d. Yes, 3 times", "e. Yes, 4 or more times")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("a. No, never")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered Yes ") +
  xlab("") +
  ggtitle("Income run out at least once in last 3 months?\n") +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.7), hjust=1, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
percentYes <- function(qn, i) {
  ...
  sd_16 <- as.integer(summary(as.factor(a16))[2])
  vd_16 <- as.integer(summary(as.factor(a16))[1])
  tot_16 <- length(a16) - length(a16[is.na(a16)])
  percent_y_16 <- (sd_16 + vd_16)* 100 / (tot_16)
...
for(i in 1:8) {
  ...
  pct_Yes_2016[i] <- percentYes(10, i)[2]
}
...
levQ11_16 <- c(levels(final$Q11_16))


final$Q11_14 <- ordered(final$Q11_14, levels=levQ11_14, labels=levQ11_14)
final$Q11_16 <- ordered(final$Q11_16, levels=levQ11_16, labels=levQ11_16)
...
Q11Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q11_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[levQ11_16[-1]]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("a. No, never")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
Q12Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q12_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))["Yes"]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("No")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
Q14Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q14_16"))
...
pct_Yes_2016[1] <- Q11Yes()[2]
pct_Yes_2014[2] <- Q12Yes()[1]
pct_Yes_2016[2] <- Q12Yes()[2]
pct_Yes_2014[3] <- Q14Yes()[1]
pct_Yes_2016[3] <- Q14Yes()[2]
...
for(i in 1:5) {
  ...
  pct_Yes_2016[i] <- percentYes(13, i)[2]
}
N_2014 <- NA
N_2016 <- NA
for(i in 1:length(x)) {
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered Yes") +
  xlab(" ") +
  ggtitle("Food sources") +
  #scale_fill_discrete(name = "", labels = c("Y in '14, N in '16", "No change", "N in '14, Y in '16")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=0.9, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")

```

Q15: Food barriers
```{r, message = FALSE, echo=FALSE, fig.height=3, fig.width=9, warning=FALSE}
...
for(i in 1:4) {
  ...
  pct_Yes_2016[i] <- percentYes(15, i)[2]
}
N_2014 <- NA
N_2016 <- NA
for(i in 1:length(x)) {
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered Yes") +
  xlab(" ") +
  ggtitle("Is this a barrier to food?\n") +
  #scale_fill_discrete(name = "", labels = c("Y in '14, N in '16", "No change", "N in '14, Y in '16")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=.8, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
final$Q16_1_16 <- ordered(final$Q16_1_16, levels = levels(final$Q16_1_16)[-6])
final$Q16_2_16 <- ordered(final$Q16_2_16, levels = levels(final$Q16_1_16)[-6])
final$Q16_3_16 <- ordered(final$Q16_3_16, levels = levels(final$Q16_1_16)[-6])
final$Q16_4_16 <- ordered(final$Q16_4_16, levels = levels(final$Q16_1_16)[-6])
final$Q16_5_16 <- ordered(final$Q16_5_16, levels = levels(final$Q16_1_16)[-6])
final$Q16_6_16 <- ordered(final$Q16_6_16, levels = levels(final$Q16_1_16)[-6])
...
for(i in 1:6) {
  ...
  pct_Yes_2016[i] <- percentYes(16, i)[2]
}
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  xlab(" ") +
  ggtitle("Transportation - dissatisfaction?\n") +
  #scale_fill_discrete(name = "", labels = c("Y in '14, N in '16", "No change", "N in '14, Y in '16")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
Q17Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q17_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("b. Yes, 1 time", "c. Yes, 2 times", "d. Yes, 3 times", "e. Yes, 4 times or more")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("a. No, never")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered Yes") +
  xlab("") +
  ggtitle("Hard to get to appts./work last 2 weeks?\n") +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.7), hjust=1, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
for(i in 1:10) {
  ...
  pct_Yes_2016[i] <- percentYes(18, i)[2]
}
N_2014 <- NA
N_2016 <- NA
for(i in 1:length(x)) {
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered Yes") +
  xlab(" ") +
  ggtitle("Is this a barrier to SS in transportation?\n") +
  #scale_fill_discrete(name = "", labels = c("Y in '14, N in '16", "No change", "N in '14, Y in '16")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_y_continuous(breaks= pretty_breaks()) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
Q19Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q19_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("Yes")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("No")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
Q20Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q20_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("a. Yes, I currently have sufficient child care")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("b. No, I currently have some child care, but need more", "c. No, I currently have no child care, but need it", "d. N/A, I currently do not need child care")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
```{r, message = FALSE, echo=FALSE, fig.height=3, fig.width=9, warning=FALSE}
#summary(as.factor(final$Q21_1_14))
#summary(as.factor(final$Q21_1_16))
...
percentSatisfied <- function(qn, i) {
  ...
  vg_16 <- sum(as.integer(summary(as.factor(a16))[c("d. Poor", "e. Very poor")]))
  g_16 <- sum(as.integer(summary(as.factor(a16))[c("a. Very good", "b. Good", "c. Neutral")]))
  tot_16 <- length(a16) - length(a16[is.na(a16)])
  percent_y_16 <- (vg_16)* 100 / (vg_16 + g_16)
...
pct_Satisfied_2014 <- pct_Satisfied_2016 <- c()
for(i in 1:3) {
  pct_Satisfied_2014[i] <- percentSatisfied(21, i)[1]
  pct_Satisfied_2016[i] <- percentSatisfied(21, i)[2]
}
...
d <- data.frame(Question = x, pct_Satisfied_2014, pct_Satisfied_2016)
...
ggplot(d, aes(reorder(Question, Percent_Satisfied), Percent_Satisfied, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  theme(
    plot.title = element_text(size=14, face="bold", vjust=3), 
    axis.text.x = element_text(size=10, angle = 0, hjust = 1), 
    axis.text.y = element_text(size=10), 
  ...
  ylab("\nPercentage who answered\n\"Very good\" or \"Good\" ") +
  xlab(" ") +
  ggtitle("Evaluate Childcare?\n") +
  #scale_fill_discrete(name = "", labels = c("Y in '14, N in '16", "No change", "N in '14, Y in '16")) +
  geom_text(aes(y = Percent_Satisfied, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
#summary(as.factor(final$Q22_2_16))
#length(final$Q22_2_16) - length(final$Q22_2_16[is.na(final$Q22_2_16)])
#summary(as.factor(final$Q22_1_14))
#summary(as.factor(final$Q22_1_16))
...
percentSatisfied <- function(qn, i) {
  ...
  vg_16 <- as.integer(summary(as.factor(a16))[2])
  g_16 <- as.integer(summary(as.factor(a16))[1])
  tot_16 <- length(a16) - length(a16[is.na(a16)])
  
  percent_y_16 <- (vg_16 + g_16)* 100 / (tot_16)
...
for(i in 1:3) {
  ...
  pct_Satisfied_2016[i] <- percentSatisfied(22, i)[2]
}
...
ggplot(d, aes(reorder(Question, Percent_Satisfied), Percent_Satisfied, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  xlab(" ") +
  ggtitle("Is this a Barrier to Childcare?\n") +
  scale_fill_discrete(name = "", labels = c("pct_NO_2014", "pct_NO_2016")) +
  geom_text(aes(y = Percent_Satisfied, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), labels = c("pct_NO_2014", "pct_NO_2016"), name="")
...
percentNever <- function(qn, i) {
  ...
  g_16 <- as.integer(summary(as.factor(a16))["a. Never"])
  tot_16 <- length(a16) - length(a16[is.na(a16)])
  percent_y_16 <- (g_16)* 100 / (tot_16)
...
pct_Never_2014 <- pct_Never_2016 <- c()
for(i in 1:5) {
  pct_Never_2014[i] <- percentNever(23, i)[1]
  pct_Never_2016[i] <- percentNever(23, i)[2]
}
...
d <- data.frame(Question = x, pct_Never_2014, pct_Never_2016)
...
ggplot(d, aes(reorder(Question, Percent_Never), Percent_Never, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  theme(
    plot.title = element_text(size=14, face="bold", vjust=3), 
    axis.text.x = element_text(size=10, angle = 0, hjust = 1), 
    axis.text.y = element_text(size=10), 
  ...
  ylab("\nPercentage who answered\n\"Never\" ") +
  xlab(" ") +
  ggtitle("Have you received help in last 3 months from ...?\n") +
  scale_fill_discrete(name = "", labels = c("pct_NO_2014", "pct_NO_2016")) +
  geom_text(aes(y = Percent_Never, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="", labels = c("pct_NO_2014", "pct_NO_2016"))
...
levQ23_16 <- c("a. Never", "b. 1-2 times", "c. 3-4 times",  "d. 5-6 times", "e. 7 times or more")
...
```{r, message = FALSE, echo=FALSE, fig.height=4, fig.width=9, warning=FALSE}
#summary(final$Q24_1_14)
#summary(final$Q24_1_16)
...
percentYes <- function(qn, i) {
  ...
  g_16 <- as.integer(summary(as.factor(a16))["Yes"])
  tot_16 <- length(a16) - length(a16[is.na(a16)])
  percent_y_16 <- (g_16)* 100 / (tot_16)
...
for(i in 1:6) {
  ...
  pct_Yes_2016[i] <- percentYes(24, i)[2]
}
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered\n\"Yes\" ") +
  xlab(" ") +
  ggtitle("Is this a Barrier to Networking?\n") +
  scale_fill_discrete(name = "", labels = c("pct_Yes_2014", "pct_Yes_2016")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
```{r, message = FALSE, echo=FALSE, fig.width=9, fig.height=4, warning=FALSE}
#summary(final$Q25_1_14)
#summary(final$Q25_1_16)
...
x <- c("Q25_1: SNAP (Food Stamps)", 
       "Q25_2: Medicaid", 
       "Q25_3: CHP+ (Colorado Health Plan Plus)", 
       "Q25_4: LEAP (Energy assistance)", 
       "Q25_5: Free/reduced lunch",
       "Q25_6: TANF (Temporary Aid to Needy Families)",
       "Q25_6: CCAP (Child Care Assistance Program)")

pct_Yes_2014 <- pct_Yes_2016 <- c()
for(i in 1:7) {
  pct_Yes_2014[i] <- percentYes(25, i)[1]
  pct_Yes_2016[i] <- percentYes(25, i)[2]
}
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered\n\"Yes\" ") +
  xlab(" ") +
  ggtitle("Do you receive the following support?\n") +
  scale_fill_discrete(name = "", labels = c("pct_Yes_2014", "pct_Yes_2016")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=.6, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
```
...
Q26Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q26_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("c. I currently have a legal problem and do not have legal assistance")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("a. I do not currently have a legal issue.", "b. I currently have legal issues and have legal assistance.")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered Yes") +
  xlab("") +
  ggtitle("Do you currently have a legal issue\n and do not have legal assistance?") +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.7), hjust=1, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
for(i in 1:4) {
  ...
  pct_Yes_2016[i] <- percentYes(27, i)[2]
}
d <- data.frame(Question = x, pct_Yes_2014, pct_Yes_2016)
d <- melt(d, id.vars = "Question", variable.name="Year", value.name="Percent_Yes")
N_2014 <- NA
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered\n\"Yes\" ") +
  xlab(" ") +
  ggtitle("Is this a barrier to resolving legal issues?\n") +
  scale_fill_discrete(name = "", labels = c("pct_Yes_2014", "pct_Yes_2016")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
Q28Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q28_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("All the members of our household have health insurance coverage, but the coverage is not adequate.", 
  ...
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("All the members of our household are covered by adequate health insurance coverage.")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
Q29Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q29_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("1. Quite poor", "2. Poor")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("3. Neutral", "4. Good", "5. Excellent")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
Q31Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q31_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("Yes")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))["No"]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
pct_Yes_2016[1] <- Q28Yes()[2]
pct_Yes_2014[2] <- Q29Yes()[1]
pct_Yes_2016[2] <- Q29Yes()[2]
pct_Yes_2014[3] <- Q31Yes()[1]
pct_Yes_2016[3] <- Q31Yes()[2]
...
levQ32_16 <- c("a. Graduate degree (Master’s/Ph.D.)", 
...
levQ33_16 <- c("a. Yes, I got it more than a year ago",
...
Q32Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q32_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("a. Graduate degree (Master’s/Ph.D.)", 
                                                     "b. Undergraduate degree (Bachelor’s/Associate’s)", 
                                                     "c. Some college", 
                                                     "d. High school diploma or GED")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("e. Did not graduate from high school")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
Q33Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q33_16"))
  
  yes_16 <- sum(as.integer(summary(as.factor(a16))[c("a. Yes, I got it more than a year ago",
                                                     "b. Yes, I got it during the last year")]))
  no_16 <- sum(as.integer(summary(as.factor(a16))[c("c. No, but I am planning to get it", 
                                                    "d. No, I am not planning to get it", 
                                                    "e. No, I am not sure if I need it")]))
  percent_y_16 <- (yes_16)* 100 / (yes_16 + no_16)
...
Q34Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q34_16"))
...
for(i in 1:12) {
  ...
  pct_Yes_2016[i] <- percentYes(35, i)[2]
}
d <- data.frame(Question = x, pct_Yes_2014, pct_Yes_2016)
d <- melt(d, id.vars = "Question", variable.name="Year", value.name="Percent_Yes")
N_2014 <- NA
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  ylab("\nPercentage who answered\n\"Yes\" ") +
  xlab(" ") +
  ggtitle("Is this a barrier to advancing\nyour education or skills?\n") +
  scale_fill_discrete(name = "", labels = c("pct_Yes_2014", "pct_Yes_2016")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
percentYes <- function(qn, i) {
  ...
  a16_lev16 <- c("1. Urgent situation, currently in crisis", "2. Vulnerable, need support to move forward", "3. Safe, family is making progress towards stability", "4. Stable, family is stable, safe and moving towards thriving", "5. Thriving, family is self-sufficient and thriving")

  #a14 <- ordered(a14, levels=a14_lev14, labels=a16_lev16)
  #a16 <- ordered(a16, levels=a16_lev16, labels=a16_lev16)

  
  one_16 <- as.integer(summary(as.factor(a16))["1. Urgent situation, currently in crisis"])
  two_16 <- as.integer(summary(as.factor(a16))["2. Vulnerable, need support to move forward"])
  thr_16 <- as.integer(summary(as.factor(a16))["3. Safe, family is making progress towards stability"])
  y_16 <- one_16 + two_16 + thr_16
  tot_16 <- length(a16) - length(a16[is.na(a16)])
  percent_y_16 <- (y_16)* 100 / (tot_16)
...
for(i in 1:11) {
  ...
  pct_Yes_2016[i] <- percentYes(36, i)[2]
}
d <- data.frame(Question = x, pct_Yes_2014, pct_Yes_2016)
d <- melt(d, id.vars = "Question", variable.name="Year", value.name="Percent_Yes")
N_2014 <- NA
...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  xlab(" ") +
  ggtitle("Self-assessment of Self-Sufficiency in...\n") +
  scale_fill_discrete(name = "", labels = c("pct_Yes_2014", "pct_Yes_2016")) +
  geom_text(aes(y = Percent_Yes, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue"), name="")
...
Q38Yes <- function() {
  ...
  a16 <-eval(parse(text = "final$Q38_16"))
