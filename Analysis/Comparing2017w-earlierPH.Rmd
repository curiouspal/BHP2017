...
ggplot(d, aes(reorder(Question, Percent_Yes), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  scale_fill_manual(values = c("darkgreen", "cadetblue", "lightblue"), name="")
```


Q3: Barriers to SS in Housing
```{r, message = FALSE, echo=FALSE, fig.height=6, fig.width=9}
...
```{r, message = FALSE, echo=FALSE, fig.height=11, fig.width=11, warning=FALSE}
...
```{r, message = FALSE, echo=FALSE, fig.height=2, fig.width=9}
...
percentYes <- function(qn, i) {
  ...
  return(c(percent_y_14, percent_y_15))
}
...
d <- data.frame(Question = x, pct_Yes_2014, pct_Yes_2015)
d <- melt(d, id.vars = "Question", variable.name="Year", value.name="Percent_Yes")
d$N <- c(N_2014, N_2015)
d$Percent_Yes_text <- paste0(as.character(round(d$Percent_Yes, 0)), "% (N=", as.character(d$N), ")", sep="")
...
Q15: Food barriers
```{r, message = FALSE, echo=FALSE, fig.height=3.5, fig.width=9, warning=FALSE}
...
ggplot(d, aes(reorder(Question, Percent_Satisfied), Percent_Satisfied, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  geom_text(aes(y = Percent_Satisfied, label=Percent_Yes_text), stat="identity", position=position_dodge(width = 0.9), hjust=1, vjust=.5, size=3, alpha=0.7) +
  scale_fill_manual(values = c("darkgreen", "cadetblue", "lightblue"), labels = c("pct_NO_2014", "pct_NO_2015", "pct_NO_2017"), name="")
...
ggplot(d, aes(reorder(Question, Percent_Never), Percent_Never, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  ...
  scale_fill_manual(values = c("darkgreen", "cadetblue", "lightblue"), name="", labels = c("pct_NO_2014", "pct_NO_2015", "pct_NO_2017"))
...
```{r, message = FALSE, echo=FALSE, fig.width=9, fig.height=5.5, warning=FALSE}
...
```{r, message = FALSE, echo=FALSE, fig.height=8, fig.width=9, warning=FALSE}
