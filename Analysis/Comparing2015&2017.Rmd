---
title: "Comparing 2017 with 2015 surveys"
...
# There are three possible TCodes that can be among the missing TCode because of which we are getting 84 TCodes in ph2014 instead of 85. These are:
# "t0000853" - "The household with this Tcode moved from one PH community to another one in 2013, so the move-out date is correct.  
# In 2014, this was the correct tcode for them. Their current tcode after conversion is T0008528." 
# "t0000151" - 
# "t0000915" - "This participant moved out of Public Housing, into the voucher program on 9/18/15.  In 2014, her tcode was t0000915, and it appears that she did complete the survey # in 2014. Her 2015 survey was completed under tcode t0009557."
...
temp <- subset(final, final$TCode %in% intersect(intersect(ph2015, ph2017), ph2014))
median(temp$Total.Annual.Income14)
median(temp$Total.Annual.Income15)
median(temp$TotalAnnualIncome_17)
ggplot(temp, aes(x=temp$PH_or_S8, y=temp$Total.Annual.Income14)) + geom_boxplot()
ggplot(temp, aes(x=temp$PH_or_S8, y=temp$Total.Annual.Income15)) + geom_boxplot()
ggplot(temp, aes(x=temp$PH_or_S8, y=temp$TotalAnnualIncome_17)) + geom_boxplot()
...
core79 <- (intersect(ph2015, ph2017))
final <- final[final$TCode %in% core79, ]
```
