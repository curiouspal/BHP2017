---
title: "Change in Housing Barriers among PH Households"
author: "Anirban Pal"
...
load("combined-New-October13-2016.RData")
...
### **Housing Barriers**
I added up all the negative (meaning condition worsened in 2017 when compared to 2015) change in responses (numerical change, unweighted) for each housing barrier sub-question for a given TCode and call it housing_negScore. Below is the distribution of housing_negScore.
...
D1 <- c("Q1:0","Q2:0","Q3_1:-1","Q3_2:-1","Q3_3:-1","Q3_4:-1","Q3_5:-1","Q3_6:-1","Q3_7:-1","Q3_8:-1","Q3_9:-1","Q4:0","Q5:0","Q60","Q7:0","Q8_1_1:0","Q8_1_2:0","Q8_1_3:0","Q8_1_4:0","Q8_1_5:0","Q8_1_6:0","Q8_1_7:0","Q8_1_8:0","Q8_1_9:0","Q8_1_10:0","Q8_1_11:0","Q8_1_12:0","Q8_1_13:0","Q8_1_14:0","Q9:0","Q10_1:0","Q10_2:0","Q10_3:0","Q10_4:0","Q10_5:0","Q10_6:0","Q10_7:0","Q10_8:0","Q11:0","Q12:0","Q13_1:0","Q13_2:0","Q13_3:0","Q13_4:0","Q13_5:0","Q14:0","Q15_1:0","Q15_2:0","Q15_3:0","Q15_4:0","Q16_10","Q16_20","Q16_30","Q16_40","Q16_50","Q16_60","Q17:0","Q18_1:0","Q18_2:0","Q18_3:0","Q18_4:0","Q18_5:0","Q18_6:0","Q18_7:0","Q18_8:0","Q18_9:0","Q18_10:0","Q19:0","Q20:0","Q21_1:0","Q21_2:0","Q21_3:0","Q22_1:0","Q22_2:0","Q22_3:0","Q23_1:0","Q23_2:0","Q23_3:0","Q23_4:0","Q23_5:0","Q24_1:0","Q24_2:0","Q24_3:0","Q24_4:0","Q24_5:0","Q24_6:0","Q25_1:0","Q25_2:0","Q25_3:0","Q25_4:0","Q25_5:0","Q25_6:0","Q25_7:0","Q26:0","Q27_1:0","Q27_2:0","Q27_3:0","Q27_4:0","Q28:0","Q290","Q31:0","Q32:0","Q33:0","Q34:0","Q35_1:0","Q35_2:0","Q35_3:0","Q35_4:0","Q35_5:0","Q35_6:0","Q35_7:0","Q35_8:0","Q35_9:0","Q35_10:0","Q35_11:0","Q35_12:0","Q36_10","Q36_20","Q36_30","Q36_40","Q36_50","Q36_60","Q36_70","Q36_80","Q36_90","Q36_100","Q36_110","Q37:0")
...
for(t in 1:length(final$TCode)) final$housing_negScore[t] <- negativeScore(final$TCode[t])  

summary(final$housing_negScore)
ggplot(final, aes(housing_negScore)) + geom_bar()
################################################################################################################
```
...
I added up all the positive (meaning condition improved in 2016 when compared to 2014) change in responses (numerical change, unweighted) for each question for a given TCode and call it housing_posScore. Below is the distribution of housing_posScore.
...
for(t in 1:length(final$TCode)) final$housing_posScore[t] <- positiveScore(final$TCode[t])  

summary(final$housing_posScore)
ggplot(final, aes(housing_posScore)) + geom_bar()
################################################################################################################

```


What is the correlation between housing_negScore and housing_posScore?
The graph is as we would expect: when housing_negScore goes up (-ve sign), the housing_posScore also goes .
```{r, echo=FALSE, fig.width=10}
final$housing_ss_diff <- (as.integer(final$Q36_1_16) - as.integer(final$Q36_1_14))
final$housing_ss_diff1 <- NA
final$housing_ss_diff1[final$housing_ss_diff<0] <- "Negative change in housing self assessment"
final$housing_ss_diff1[final$housing_ss_diff>0] <- "Positive change in housing self assessment"
final$housing_ss_diff1[final$housing_ss_diff==0] <- "No change in housing self assessment"
final$housing_ss_diff1 <- as.factor(final$housing_ss_diff1)
ggplot(final, aes(housing_negScore, housing_posScore)) + geom_point(alpha=0.3, color="red", size=4) 
ggplot(final, aes(housing_negScore, housing_posScore)) + geom_text(aes(label = TCode, color=housing_ss_diff1), size = 4)

```

The following TCodes had the highest housing_negScore:
```{r, echo=FALSE, fig.width=10}

temp <- data.frame(TCode=final$TCode, housing_negScore=final$housing_negScore)
temp <- temp[order(temp$housing_negScore),][c(1,2),]
pander(temp)
