...
pct_Yes_2014 <- c(100*length(final$Member.Citizen14[final$Member.Citizen14=="IN"& !is.na(final$Member.Citizen14)])/length(final$Member.Citizen14[!is.na(final$Member.Citizen14)]),
                  ...
                  100*length(final$Member.Ethnicity14[final$Member.Ethnicity14==1 & !is.na(final$Member.Ethnicity14)])/length(final$Member.Ethnicity14[!is.na(final$Member.Ethnicity14)]),
...
pct_Yes_2015 <- c(100*length(final$Member.Citizen_15[final$Member.Citizen_15=="IN"& !is.na(final$Member.Citizen_15)])/length(final$Member.Citizen_15[!is.na(final$Member.Citizen_15)]),
                  ...
                  100*length(final$Member.Ethnicity15[final$Member.Ethnicity15==1 & !is.na(final$Member.Ethnicity15)])/length(final$Member.Ethnicity15[!is.na(final$Member.Ethnicity15)]),
...
ggplot(d, aes((Question), Percent_Yes, group=Year)) + geom_bar(stat = "identity", width = 0.7, position="dodge", aes(fill=Year), alpha=0.7) +
  theme(
    ...
    axis.text.x = element_text(size=14, angle = 0, hjust = 1, color = "black"), 
  ...
  geom_text(aes(y = Percent_Yes, label=round(Percent_Yes, 0)), stat="identity", position=position_dodge(width = 0.7), hjust="inward", vjust="inward",  alpha=0.8) +
